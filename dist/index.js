define("@scom/oswap-farming-contract/contracts/@openzeppelin/contracts/token/ERC20/ERC20.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("@scom/oswap-farming-contract/contracts/@openzeppelin/contracts/token/ERC20/ERC20.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/@openzeppelin/contracts/token/ERC20/ERC20.json.ts"], function (require, exports, eth_contract_1, ERC20_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/Farming.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/Farming.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/Farming.json.ts"], function (require, exports, eth_contract_2, Farming_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Farming = void 0;
    class Farming extends eth_contract_2.Contract {
        constructor(wallet, address) {
        ...
        decodeDepositEvent(event) {
            ...
            return {
                user: result.user,
                pid: new eth_contract_2.BigNumber(result.pid),
        ...
        decodeHarvestEvent(event) {
            ...
            return {
                user: result.user,
                pid: new eth_contract_2.BigNumber(result.pid),
                rewardId: new eth_contract_2.BigNumber(result.rewardId),
                amount: new eth_contract_2.BigNumber(result.amount),
                locked: new eth_contract_2.BigNumber(result.locked),
                _event: event
            };
        }
        ...
        decodeLogPoolAdditionEvent(event) {
            ...
            return {
                pid: new eth_contract_2.BigNumber(result.pid),
                allocPoint: new eth_contract_2.BigNumber(result.allocPoint),
                lpToken: result.lpToken,
                endBlock: new eth_contract_2.BigNumber(result.endBlock),
                bonusMultiplier: new eth_contract_2.BigNumber(result.bonusMultiplier),
                bonusEndBlock: new eth_contract_2.BigNumber(result.bonusEndBlock),
                _event: event
            };
        }
        ...
        decodeLogRewardAdditionEvent(event) {
            ...
            return {
                ...
                multiplier: new eth_contract_2.BigNumber(result.multiplier),
                vestingRatio: new eth_contract_2.BigNumber(result.vestingRatio),
                vestingStartOnHarvest: result.vestingStartOnHarvest,
                vestingDuration: new eth_contract_2.BigNumber(result.vestingDuration),
                _event: event
            };
        }
        ...
        decodeLogUpdatePoolEvent(event) {
            ...
            return {
                pid: new eth_contract_2.BigNumber(result.pid),
                lastRewardBlock: new eth_contract_2.BigNumber(result.lastRewardBlock),
                lpSupply: new eth_contract_2.BigNumber(result.lpSupply),
                accSushiPerShare: new eth_contract_2.BigNumber(result.accSushiPerShare),
                _event: event
            };
        }
        ...
        assign() {
            ...
            let pendingReward_call = async (params, options) => {
                ...
                return {
                    rewardToken: result.rewardToken,
                    availableNow: result.availableNow.map(e => new eth_contract_2.BigNumber(e)),
                    toBeVested: result.toBeVested.map(e => new eth_contract_2.BigNumber(e)),
                    vestingStart: result.vestingStart.map(e => new eth_contract_2.BigNumber(e)),
                    vestingDuration: result.vestingDuration.map(e => new eth_contract_2.BigNumber(e))
                };
            };
            ...
            let poolInfo_call = async (param1, options) => {
                ...
                return {
                    ...
                    bonusMultiplier: new eth_contract_2.BigNumber(result.bonusMultiplier),
                    bonusEndBlock: new eth_contract_2.BigNumber(result.bonusEndBlock),
                    rewardDebt: new eth_contract_2.BigNumber(result.rewardDebt),
                    lastRewardBlock: new eth_contract_2.BigNumber(result.lastRewardBlock),
                    accRewardPerShare: new eth_contract_2.BigNumber(result.accRewardPerShare)
                };
            };
            ...
            let rewardInfo_call = async (param1, options) => {
                ...
                return {
                    ...
                    vestingStartOnHarvest: result.vestingStartOnHarvest,
                    vestingDuration: new eth_contract_2.BigNumber(result.vestingDuration),
                    rewarded: new eth_contract_2.BigNumber(result.rewarded),
                    reserve: new eth_contract_2.BigNumber(result.reserve)
                };
            };
            ...
            let userRewards_call = async (params, options) => {
                ...
                return {
                    harvested: new eth_contract_2.BigNumber(result.harvested),
                    locked: new eth_contract_2.BigNumber(result.locked),
                    lockedTill: new eth_contract_2.BigNumber(result.lockedTill),
                    lastUpdate: new eth_contract_2.BigNumber(result.lastUpdate)
                };
            };
...
define("@scom/oswap-farming-contract/contracts/MasterChef.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/MasterChef.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/MasterChef.json.ts"], function (require, exports, eth_contract_3, MasterChef_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MasterChef = void 0;
    class MasterChef extends eth_contract_3.Contract {
        constructor(wallet, address) {
        ...
        decodeDepositEvent(event) {
            ...
            return {
                user: result.user,
                pid: new eth_contract_3.BigNumber(result.pid),
        ...
        decodeLogPoolAdditionEvent(event) {
            ...
            return {
                pid: new eth_contract_3.BigNumber(result.pid),
                allocPoint: new eth_contract_3.BigNumber(result.allocPoint),
                lpToken: result.lpToken,
                _event: event
            };
        }
        ...
        decodeLogUpdatePoolEvent(event) {
            ...
            return {
                pid: new eth_contract_3.BigNumber(result.pid),
                lastRewardBlock: new eth_contract_3.BigNumber(result.lastRewardBlock),
                lpSupply: new eth_contract_3.BigNumber(result.lpSupply),
                accSushiPerShare: new eth_contract_3.BigNumber(result.accSushiPerShare),
                _event: event
            };
        }
        parseWithdrawEvent(receipt) {
        ...
        assign() {
            ...
            let poolInfo_call = async (param1, options) => {
                ...
                return {
                    ...
                    allocPoint: new eth_contract_3.BigNumber(result.allocPoint),
                    lastRewardBlock: new eth_contract_3.BigNumber(result.lastRewardBlock),
                    accRewardsPerShare: new eth_contract_3.BigNumber(result.accRewardsPerShare)
                };
            };
            this.poolInfo = poolInfo_call;
            let poolLength_call = async (options) => {
            ...
            let userInfo_call = async (params, options) => {
                ...
                return {
                    amount: new eth_contract_3.BigNumber(result.amount),
                    rewardDebt: new eth_contract_3.BigNumber(result.rewardDebt)
                };
            };
            this.userInfo = userInfo_call;
            let whitelisted_call = async (param1, options) => {
...
define("@scom/oswap-farming-contract/contracts/Redeeming.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/Redeeming.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/Redeeming.json.ts"], function (require, exports, eth_contract_4, Redeeming_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Redeeming = void 0;
    class Redeeming extends eth_contract_4.Contract {
        constructor(wallet, address) {
        ...
        decodeRedeemEvent(event) {
            ...
            return {
                account: result.account,
                token: result.token,
                vesting: new eth_contract_4.BigNumber(result.vesting),
                reward: new eth_contract_4.BigNumber(result.reward),
                _event: event
            };
        }
        assign() {
            ...
            let availableRewardAmount_call = async (account, options) => {
                ...
                return {
                    ...
                    availableReward: result.availableReward.map(e => new eth_contract_4.BigNumber(e))
                };
            };
...
define("@scom/oswap-farming-contract/contracts/VestingToken.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/VestingToken.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/VestingToken.json.ts"], function (require, exports, eth_contract_5, VestingToken_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.VestingToken = void 0;
    class VestingToken extends eth_contract_5.Contract {
        constructor(wallet, address) {
        ...
        decodeLockEvent(event) {
            ...
            return {
                account: result.account,
                direct: new eth_contract_5.BigNumber(result.direct),
...
define("@scom/oswap-farming-contract/contracts/draft/AutoVestingToken.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/draft/AutoVestingToken.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/draft/AutoVestingToken.json.ts"], function (require, exports, eth_contract_6, AutoVestingToken_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AutoVestingToken = void 0;
    class AutoVestingToken extends eth_contract_6.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-farming-contract/contracts/draft/MasterChefV2.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/draft/MasterChefV2.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/draft/MasterChefV2.json.ts"], function (require, exports, eth_contract_7, MasterChefV2_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MasterChefV2 = void 0;
    class MasterChefV2 extends eth_contract_7.Contract {
        constructor(wallet, address) {
        ...
        decodeDepositEvent(event) {
            ...
            return {
                user: result.user,
                pid: new eth_contract_7.BigNumber(result.pid),
        ...
        decodeLogPoolAdditionEvent(event) {
            ...
            return {
                pid: new eth_contract_7.BigNumber(result.pid),
                allocPoint: new eth_contract_7.BigNumber(result.allocPoint),
                lpToken: result.lpToken,
                _event: event
            };
        }
        ...
        decodeLogUpdatePoolEvent(event) {
            ...
            return {
                pid: new eth_contract_7.BigNumber(result.pid),
                lastRewardBlock: new eth_contract_7.BigNumber(result.lastRewardBlock),
                lpSupply: new eth_contract_7.BigNumber(result.lpSupply),
                accRewardsPerShare: new eth_contract_7.BigNumber(result.accRewardsPerShare),
                _event: event
            };
        }
        parseWithdrawEvent(receipt) {
        ...
        assign() {
            ...
            let userInfo_call = async (params, options) => {
                ...
                return {
                    amount: new eth_contract_7.BigNumber(result.amount),
                    rewardDebt: new eth_contract_7.BigNumber(result.rewardDebt)
                };
            };
            this.userInfo = userInfo_call;
            let whitelisted_call = async (param1, options) => {
...
define("@scom/oswap-farming-contract/contracts/test/MockERC20.json.ts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract/contracts/test/MockERC20.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-farming-contract/contracts/test/MockERC20.json.ts"], function (require, exports, eth_contract_8, MockERC20_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MockERC20 = void 0;
    class MockERC20 extends eth_contract_8.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-farming-contract/contracts/index.ts", ["require", "exports", "@scom/oswap-farming-contract/contracts/@openzeppelin/contracts/token/ERC20/ERC20.ts", "@scom/oswap-farming-contract/contracts/Farming.ts", "@scom/oswap-farming-contract/contracts/MasterChef.ts", "@scom/oswap-farming-contract/contracts/Redeeming.ts", "@scom/oswap-farming-contract/contracts/VestingToken.ts", "@scom/oswap-farming-contract/contracts/draft/AutoVestingToken.ts", "@scom/oswap-farming-contract/contracts/draft/MasterChefV2.ts", "@scom/oswap-farming-contract/contracts/test/MockERC20.ts"], function (require, exports, ERC20_1, Farming_1, MasterChef_1, Redeeming_1, VestingToken_1, AutoVestingToken_1, MasterChefV2_1, MockERC20_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-farming-contract", ["require", "exports", "@scom/oswap-farming-contract/contracts/index.ts"], function (require, exports, Contracts) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
